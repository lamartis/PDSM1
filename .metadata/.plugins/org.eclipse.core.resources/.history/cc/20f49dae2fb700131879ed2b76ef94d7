...
public class SaveArchiveResponseTraitement extends TraitementI {

	SaveArchiveResponse saveArchiveResponse;
	User user;

	public SaveArchiveResponseTraitement(M2iInterface object, String idMessage, String correlationId){
	...
	public Void call() throws Exception {
		...
		if (user != null) {
			...
			LoggerSingleton.getInstance().addInfoLog("L'archive est supprimé : " + servletContext.getRealPath(accountsFolder + user.getLogin() + "/" + saveArchiveResponse.getNomArchive()));
			zipFile.delete();
